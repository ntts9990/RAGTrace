...
|--------|------|--------|----------|--------|--------|---------------|
| answer_relevancy | 0.883 | 0.883 | 0.033 | 0.859 | 0.906 | 0.047 |
...
- **변동성**: 표준편차 0.033 (변동계수: 0.04)
- **분포**: 최소 0.859 ~ 최대 0.906
- **중앙값**: 0.883
